        ...
        <div class="row">
            <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar">
                <ul class="nav nav-pills flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ $classes->count() == 0 ? 'disabled' : '' }}" id="v-pills" data-toggle="pill" href="#assignment" role="tab" aria-controls="v-pills-home"
            ...
            <main class="col-sm-9 ml-sm-auto col-md-10 pt-3" role="main">
                <div class="tab-content container" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade {{ $classes->count() == 0 ? '' : '' }}" id="assignment" role="tabpanel" aria-labelledby="quiz-events">
                        ...
                        {{--  <button class="btn btn-primary" data-toggle="modal" data-target="#NewQuizEventModal">New quiz event</button>  --}}
                        <a class="btn btn-primary" href="create/assignment">New Assignment event</a>
                    </div>
...
<script>
    ...
    function goToQuizPanel(){
        $('.nav-item a[href="#assignment"]').tab('show');
    }
